...
class IncidenciaEnergiaController extends Controller
{
    /**
    ...
    public function index()
    {
        return response()->json([
            ...
            'porciento_energia' => Energia::pluck('Energiap')->all(),
    ...
    public function store(Request $request)
    {
        ...
        $plan_real_petroleo = IncidenciaEnergia::where('energiad', $request->energia)->first();
