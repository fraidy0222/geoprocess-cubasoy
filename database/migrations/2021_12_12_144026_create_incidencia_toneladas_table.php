...
class CreateIncidenciaToneladasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('incidencia_toneladas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('incidencia_toneladas');
    }
}
